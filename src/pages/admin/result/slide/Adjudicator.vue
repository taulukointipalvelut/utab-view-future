<template lang="pug">
  .router-view-content(v-if="target_tournament")
    ...
    slides-wrapper.slides(title="Adjudicator Results", :max_ranking_rewarded="max_ranking_rewarded", :credit="credit", :organized_results="organized_results", label="adjudicators", :type="type")
</template>

<template lang="pug">
  .router-view-content(v-if="target_tournament")
    ...
    slides-wrapper(title="Speaker Result", :max_ranking_rewarded="max_ranking_rewarded", :credit="credit", :organized_results="organized_results", label="speakers", sub_label="teams", :type="type")
</template>

<template lang="pug">
  #app-content
    utab-header(:login="isAuth", :login_href="auth.href.login", logout_href="auth.href.logout")
    main
      h1 Welcome!
      link-list(:loading="loading", no_item_text="No Tournament Available")
        legend(slot="legend") Tournaments
        router-link(v-for="tournament in tournaments", :to="tournament.href.to", :key="tournament")
